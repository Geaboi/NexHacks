...
from routes import health_router, pose_router, overshoot_router
...
if __name__ == "__main__":
    ...
    uvicorn.run("main:app", host="0.0.0.0", port=8000, reload=True, log_level="debug", log_config=uvicorn.config.LOGGING_CONFIG, workers=1)
